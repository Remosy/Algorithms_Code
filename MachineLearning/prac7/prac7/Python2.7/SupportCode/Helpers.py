...
def openTensorBoard(trainPath,testPath,portTrain=8001,portTest=8002):
  ...
  proc = subprocess.Popen(['tensorboard', '--logdir=' + trainPath, '--port=' + str(portTrain)])
  proc2 = subprocess.Popen(['tensorboard', '--logdir=' + testPath, '--port=' + str(portTest)])
  time.sleep(1)
