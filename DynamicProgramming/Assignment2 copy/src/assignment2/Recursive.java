...
public class Recursive {
    ...
    private static int optimalCostRecursive(List<List<Integer>> queues,
        ...
        if (front.get(0)==queues.get(0).size() && front.get(1)==queues.get(1).size() && front.get(2)==queues.get(2).size()){
            return 0;
        }
        ...
        for (int i = 0; i < queues.size(); i++) {
            ...
            SequentialPairAction sequentialPairAction = new SequentialPairAction(i);
